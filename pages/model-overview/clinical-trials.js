  ...
  return (
    <>
      ...
      >
        ...
        <Card>
          <div id="AMC" className="imageStyle">
            <Image src={Images.CTAMC} height="100" width="100" alt="" />
          </div>
          <div>
            <p className="black">
              <b className="bolder">Academic Medical Centers</b>: Human trials
              are typically undertaken at hospitals in research centers.
              Although clinical trials are considered primarily research and
              conducted by researchers, they are dependent upon hospital
              resources and infrastructure, such as nursing support, pharmacy
              support, and clinic space. Studies are sometimes
        ...
        <Card>
          ...
          <div>
            <p className="black">
              ...
              design and execution. Institutional research ethics boards and
              other entities monitor (animal and human) safety, in particular,
        ...
        <Card>
          <div id="industry" className="imageStyle">
          ...
          <div>
            <p className="black">
              ...
              candidate into clinical use. This is due in part to the
              prohibitive costs associated with executing clinical trials and
              the need for multi-centred trials to enroll a sufficient number of
              subjects. They also offer human capital to help run studies,
              collect data, and ensure research procedures are followed and
              regulations/ethical guidelines are met.
            </p>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div>
            <p className="black">
              ...
              in designing and executing trials on behalf of industry partners,
              as well as data analysis, regulatory affairs management, and data
              analysis.
            </p>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div>
            <p className="black">
              ...
              run the trials themselves. Finding patients to participate in
              trials may also prove challenging, especially in the context of
              rare diseases; funding traveling patients is costly given that
              trials often occur in large urban centers.
            </p>
          </div>
        </Card>

        <Card>
          <div id="funding" className="imageStyle">
          ...
          <div>
            <p className="black">
              ...
              through P3. Sourcing capital from public and private
              firms/sponsors (e.g. public funding agencies, philanthropic
              foundations, venture capital funds etc.) is a significant
              challenge. Travel and per diem costs for families of participants
        ...
        <Card>
          ...
          <div>
            <p className="black">
              ...
              of bureaucratic hurdles faced by developers at this stage,
              including but not limited to executing research contracts, meeting
        ...
        <Card>
          <div id="RDHurdles" className="imageStyle">
            <Image src={Images.CTRDHurdles} height="100" width="100" alt="" />
          </div>
          <div>
            <p className="black">
              <b className="bolder">R&D Hurdles</b>: There are numerous
              scientific challenges faced throughout human clinical trials,
              including but not limited to undertaking reproductive toxicology
              and carcinogenicity testing, and scaling up from P1 to P2 to P3.
              Trial failures, where a drug may prove to be toxic or ineffective
              for a specific indication, are a common barrier faced at all
        ...
        <Card>
          <div id="data" className="imageStyle">
            <Image src={Images.CTDataSharing} width="100" height="100" alt="" />
          </div>
          <div>
            <p className="black">
              <b className="bolder">Data Sharing</b>: Issues surrounding data
              sharing present another barrier in the clinical trial stage. This
              is particularly acute in the case of public/private partnerships,
              and when human subjects are involved in research, as privacy and
