        ...
        <div>
          <div className="bg-[#00a122] mt-[-10px] relative flex flex-col content-center px-0">
            <p className="containerGlobal text-center px-[50px] py-[60px]">
              ...
              demonstrated to have a functional role in the disease, a chemical
              lead with an affinity and selectivity for the target is identified
              and optimized. Researchers test whether the compound is
              “druggable” and can bind to the target by evaluating its
