            ...
            <>
                ...
                <div>
                    <div className="bg-[#00a122] mt-[-10px] relative flex flex-col content-center px-0">
                        <p className="containerGlobal text-center px-[50px] py-[60px]">Prior to testing in humans, drug developers must file their Investigational New Drug (IND) application with their governing regulatory body. This IND application includes preclinical and toxicity study data, and drug manufacturing information. Clinical research protocols outlining selection criteria for trial participants, number of participants, duration of study, dose and administration route, and data collection and analysis are also included in the IND application.</p>
                    </div>
                </div>
