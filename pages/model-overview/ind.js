        ...
        <div>
          <div className="bg-[#00a122] mt-[-10px] relative flex flex-col content-center px-0">
            <p className="containerGlobal text-center px-[50px] py-[60px]">
              ...
              toxicity study data, and drug manufacturing information. Clinical
              research protocols outlining selection criteria for trial
              participants, number of participants, duration of study, dose and
              administration route, and data collection and analysis are also
