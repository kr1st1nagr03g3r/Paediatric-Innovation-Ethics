      ...
      <>
        ...
        <Card>
          ...
          <div className="basis-3/4">
            <p className="bolder">
              CRO: In the pre-clinical stage, Contract Research Organizations
              (CROs) are contracted by universities to test new drug candidates
              prior to human testing. This typically includes compound synthesis
              and conducting animal studies.
            </p>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="basis-3/4">
            <p className="bolder">
              Bureaucratic Hurdles: Bureaucratic hurdles in the drug discovery
              stage include but are not limited to filing for human subjects,
              IRB approval, negotiating contracts, managing IP filings, and
              other organizational issues. Hurdles often occur at points of
              interaction between different stakeholders (e.g. scientists
              acquiring lab space within a university, research teams partnering
              with a contract research organization, TTOs mediating between
              research teams, administrative staff managing funding and research
              group members).{' '}
            </p>
          </div>
        </Card>
        ...
        <CardLast>
          ...
          <div className="basis-3/4">
            <p className="bolder">
              Research Translation: Translating benchwork to animal studies is
              another hurdle faced by researchers at this stage. Before human
              trials can begin, ideas from the earliest phase of drug discovery
              must be translated successfully into animal studies to test the
              proof of principal in vivo.{' '}
            </p>
          </div>
        </CardLast>
