      ...
      <>
        ...
        >
            ...
            <div>
              <div>
                <p>
                  ...
                  conducted to understand optimal dosage, rates of metabolism
                  and elimination, and the half-life of the drug. Toxicologic
                  studies help to shed light on the drug&apos;s potential
                  toxicity. This stage involves regulatory oversight and
                  approval to ensure that studies are conducted safely and
                  ethically.{' '}
                </p>
              </div>
            </div>
          ...
          <Card>
            ...
            <div>
              <p className="black">
                <b className="bolder">CRO:</b> In the pre-clinical stage,
                Contract Research Organizations (CROs) are contracted by
                universities to test new drug candidates prior to human testing.
                This typically includes compound synthesis and conducting animal
                studies.
              </p>
            </div>
          </Card>
          ...
          <Card>
            ...
            <div>
              <p className="black">
                ...
                to filing for human subjects, IRB approval, negotiating
                contracts, managing IP filings, and other organizational issues.
                Hurdles often occur at points of interaction between different
