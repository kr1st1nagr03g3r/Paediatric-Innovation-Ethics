...
const solutions = [
    {
        name: 'Roadblocks',
        description: 'Labore dolor mollit officia ad elit. Laboris tempor minim dolore cupidatat anim. Ea velit Lorem aliqua eu do laborum quis consequat.',
        href: '#',
        icon: BlockIcon,
    },
    // {
...
const callsToAction = [
    { name: 'See More', href: '#', icon: ArrowCircleRightIcon },
