...
export default function Tooltip14() {
  return (
    <>
      <style jsx>{`
        .red,
      ...
      <HtmlTooltip
        ...
        title={
          <>
            <Box>
              <h3 className="bold tooltipTitle">Regulatory Agencies</h3>
              <p className="black fade">
                Regulatory agencies are tasked with ensuring drug manufacturers
                are meeting jurisdictional standards related to drug pricing,
                labeling, off-label use, quality, safety, monitoring serious
