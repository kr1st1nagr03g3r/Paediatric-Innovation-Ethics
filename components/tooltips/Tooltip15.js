...
export default function Tooltip15() {
  return (
    <>
      <style jsx>{`
        .red,
      ...
      <HtmlTooltip
        ...
        title={
          <>
            <Box>
              <h3 className="bold tooltipTitle">Insurance Agencies & Payors</h3>
              <p className="black fade">
                Insurance agencies and provincial payors undertake cost/benefit
                analyses to make decision on reimbursement, which significantly
                impacts patient access to new, often costly, drugs.
              </p>
